...
const ClothingColor = ({ avatarSVG, sx, item }) => {
        ...
        <Box>
          <Box
            sx={{
              ...
              overflow: "hidden",
              border:
                avatarChange.clothingColor === item
                  ? "3px solid #419fe8"
                  : "2px solid #23303a",
          ...
          >
            ...
            >
              <BigHead {...avatarChange} clothingColor={item} />
            </Box>
          </Box>
        </Box>
        <Typography
...
export default memo(ClothingColor);
