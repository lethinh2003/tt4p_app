...
const FaceMaskColor = ({ avatarSVG, sx, item }) => {
        ...
        <Box>
          <Box
            sx={{
              ...
              overflow: "hidden",
              border:
                avatarChange.faceMaskColor === item
                  ? "3px solid #419fe8"
          ...
          >
            ...
            >
              <BigHead {...avatarChange} faceMaskColor={item} />
            </Box>
          </Box>
        </Box>
        <Typography
...
export default memo(FaceMaskColor);
